...
class Dashboard extends CI_Controller {
	...
	public function dashboard_admin_utama()
	{
		...
		// echo var_dump($data['data_chart']);
		// die();
		$this->load->view('admin_utama/admin_utama_dashboard', $data);
	...
	public function chart_Data(){
		if ($this->session->userdata('logged_in') == true AND $this->session->userdata('id_user_level') == 1 OR $this->session->userdata('id_user_level') == 2 OR $this->session->userdata('id_user_level') == 3 ) {
