...
class Kerja_sama_internal extends CI_Controller {
	...
	public function view_admin_utama()
	{
		if ($this->session->userdata('logged_in') == true AND $this->session->userdata('id_user_level') == 3) {
			...
			$data['status_kerja_sama'] = $this->m_status_kerja_sama->get_status_kerja_sama();
			$data['user'] = $this->m_user->get_user();
		$this->load->view('admin_utama/view_kerja_sama_internal', $data);
	...
	public function input_data_admin_utama(){
		...
		$file_kerja_sama_internal_upload = $this->upload->do_upload('file_kerja_sama_internal');
			...
			if($file_kerja_sama_internal_upload){
				...
				$this->session->set_flashdata('error_file','error_file');
				redirect('Kerja_sama_internal/view_admin_utama');
			}
	...
	public function hapus_kerja_sama_internal_admin_utama($id_kerja_sama_internal)
	{
	if ($this->session->userdata('logged_in') == true AND $this->session->userdata('id_user_level') == 3) {
		// $file = $this->input->post('file_kerja_sama_internal_old');
		// echo $file;
