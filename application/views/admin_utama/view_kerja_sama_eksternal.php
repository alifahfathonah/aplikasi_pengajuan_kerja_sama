                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form
                                                        action="<?php echo base_url()?>Kerja_sama_eksternal/hapus_kerja_sama_eksternal_admin_utama/<?=$id_kerja_sama_eksternal?>"
                                    ...
                                    <div class="modal fade"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form
                                                        action="<?= base_url(); ?>Kerja_sama_eksternal/edit_data_admin_utama"
                        ...
                        <div class="modal fade" id="tambah_kerja_sama_eksternal" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?= base_url(); ?>Kerja_sama_eksternal/input_data_admin_utama"
                                            enctype="multipart/form-data" method="POST">
                                            <div class="mb-3">
